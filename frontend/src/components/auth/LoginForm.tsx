...
//           <p className="text-slate-400 mt-1 text-sm">Sign in to manage your tasks</p>
//         </div>
...
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Auth call and behavior are unchanged. "Remember me" only controls
      // whether the session persists in localStorage vs sessionStorage —
      // it does not alter the login request itself.
          ...
          >
            ...
            <div className="rounded-[24px] border border-[#E5E7EB] bg-white/80 p-8 shadow-[0_8px_30px_rgba(16,24,40,0.06)] backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04]">
              ...
              <p className="mt-1 text-sm text-[#6B7280] dark:text-slate-400">
                Sign in to continue managing your AI tasks.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4" noValidate>
                ...
                <label className="flex select-none items-center gap-2 text-sm text-[#6B7280] dark:text-slate-400">
                  <input
                    type="checkbox"
                    checked={rememberMe}
